    ...
    <section className="py-20 px-4">
      <div className="max-w-[960px] mx-auto bg-primary rounded-3xl p-10 md:p-16 text-center text-white relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col items-center gap-8">
          ...
          <p className="text-blue-100 text-lg max-w-[600px]">Join thousands of freelancers and businesses who trust iConcur for their agreements.</p>
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
            <button className="flex items-center justify-center h-14 px-8 bg-white text-primary text-lg font-bold rounded-xl hover:bg-gray-100 transition-colors shadow-lg">
              Get Started Free
            </button>
